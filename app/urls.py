...
urlpatterns = [
    ...
    # Balance Sheet
    path('balance-sheet/',         views.balance_sheet_filter,       name='balance_sheet_filter'),
    path('balance-sheet/report/',  views.balance_sheet_report,       name='balance_sheet_report'),
    path('balance-sheet/export/',  views.balance_sheet_export_excel, name='balance_sheet_export'),
    
    # Trial Balance
    path('trial-balance/',         views.trial_balance_filter,       name='trial_balance_filter'),
    path('trial-balance/report/',  views.trial_balance_report,       name='trial_balance_report'),
    path('trial-balance/export/',  views.trial_balance_export_excel, name='trial_balance_export'),
]